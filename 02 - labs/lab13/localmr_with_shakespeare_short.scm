...
;; Load data
(load "lib/localmr-beatles.scm")
(load "lib/localmr-emails.scm")
; added
(load "lib/localmr-shakespeare-short.scm")
...
(define (lmapreduce mapper reducer base-case input)
  (cond ((equal? input "/beatles-songs")
	...
	; added
	((equal? input "/shakespeare-short")
	 (local-map-reduce mapper reducer base-case shakespeare-short))
	(else
